# Architecture Principles for Backend Modernization

These principles guide design decisions and help evaluate solutions. Use them when making architectural choices, reviewing designs, or resolving trade-offs.

> **How to use**: When facing a design decision, ask "which option best aligns with these principles?" Document trade-offs in an ADR when principles conflict.
...
**When to apply**: Always. This is foundational.
...
**When to apply**: Always. No API or event without a contract.
...
**When to apply**: Always. Keep orchestration separate from business logic.
...
**When to apply**: Always. Security is non-negotiable.
...
**When to apply**: From day one. Observability is not optional.
...
**When to apply**: Always when replacing existing systems.
...
**When to apply**: Always. Exceptions need ADRs with sunset dates.
...
**When to apply**: Always. No shared databases.
...
**When to apply**: Always. Compliance is not optional.
