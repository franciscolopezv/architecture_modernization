...
This document describes a **reference architecture** for server-side systems. Use it whether you're modernizing legacy systems or building new ones. This represents good practices, not the only way to build systems.
