...
Too many dependencies? Fix the organization first: [team-topologies.md](strategy/team-topologies) → [prerequisites.md](strategy/prerequisites) (see "Conway's Law" section). Then realign services to match domain boundaries.
