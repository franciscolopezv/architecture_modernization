...
Read [prerequisites.md](strategy/prerequisites) first to ensure:
...
Start with [vision.md](strategy/vision) to understand:
...
Review [target-architecture.md](strategy/target-architecture) to understand the **reference architecture**:
...
Read [principles.md](principles) to understand the design principles that guide all decisions:
- Domain ownership
...
Review [team-topologies.md](strategy/team-topologies) to ensure your team structure supports independent flow:
...
Use [maturity-model.md](strategy/maturity-model) to:
...
**Solution:** Read [prerequisites.md](strategy/prerequisites) and address gaps before building services.
...
**Solution:** Fix team structure first ([team-topologies.md](strategy/team-topologies)), then modernize architecture.
...
**Solution:** Each service owns its data ([data-ownership-guide.md](principles/data-ownership-guide)). Share via APIs or events.
